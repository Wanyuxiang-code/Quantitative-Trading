"""Creating manual strategy using the indicators"""
...
def testPolicy(symbol = "AAPL", sd=dt.datetime(2010,1,1), ed=dt.datetime(2011,12,31), sv = 100000):
    ...
    for index, row in prices_normalized.iterrows():
        ...
        if (momentum_value < -0.05) and (bbp_value < 0.2) and (total_holdings < 1000):
            ...
            if total_holdings == 0:
                ...
                total_holdings += 2000
        elif (momentum_value > 0.05) and (bbp_value > 0.8) and (total_holdings > -1000):
